...
public class AssemblingConveyorTest {
	...
	public void test() throws InterruptedException {
		AssemblingConveyor<Integer, Cart<Integer,?>, NameBuilder> c = new AssemblingConveyor<Integer, Cart<Integer,?>, NameBuilder>((Class<? extends Builder<NameBuilder>>) NameBuilder.class);
