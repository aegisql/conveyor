 ...
 */
public abstract class HashConveyor<K, L, IN extends Cart<K, ?, L>, OUT> implements Conveyor<K, L, IN, OUT> {

	/** The Constant LOG. */
	private final static Logger LOG = LoggerFactory.getLogger(HashConveyor.class);
