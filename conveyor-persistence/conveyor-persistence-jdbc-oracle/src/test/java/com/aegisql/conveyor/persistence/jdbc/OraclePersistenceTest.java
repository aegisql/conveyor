...
public class OraclePersistenceTest {
	...
	public static void setUpBeforeClass() {
		...
		Tester.removeLocalOracleTables("PART", "COMPLETED_LOG", "EXP_TEST", "EXP_TEST_COMPLETE", "PART2", "COMPLETED_LOG2");
	}
