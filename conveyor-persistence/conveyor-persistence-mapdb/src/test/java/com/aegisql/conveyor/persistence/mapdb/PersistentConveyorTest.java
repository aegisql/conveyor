...
public class PersistentConveyorTest {
	...
	public void veryBasicTest() throws InterruptedException {
		Persistence<Integer> p = new MapDBPersistence(DB_PATH,"test");
...
//		assertTrue(p.isEmpty());
	...
	public void simpleReplayTest() throws InterruptedException {
		Persistence<Integer> p1 = new MapDBPersistence(DB_PATH,"test");
		...
		Persistence<Integer> p2 = new MapDBPersistence(DB_PATH,"test");
