...
public class SqlitePerfTest {
	...
	public static void setUpBeforeClass() throws Exception {
		...
		Tester.removeFile("perfConvArchive.db");
		Tester.removeFile("parallel1.db");
	...
	Persistence<Integer> getPersitence(String schema, String table) {
		try {
			Thread.sleep(1000);
	...
	public void testParallelParallelAsorted() throws InterruptedException {
		...
		Persistence<Integer> p1 = getPersitence("parallel1.db","testParallelAsorted");
		Persistence<Integer> p2 = getPersitence("parallel2.db","testParallelAsorted");
